...
## --------- ##
# Llevamos el Schema a routers/user.py
...
## --------- ##
# Llevamos el Schema a routers/movie.py
...
## ------------ ##
# Llevamos todas las rutas de usuarios a la carpeta routers/user.py
...
## ------------ ##
# Llevamos todas las rutas de movies a la carpeta routers/movies.py
